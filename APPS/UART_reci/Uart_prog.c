...
void Uart_vidInit(void)
{
	...
	UCSRA = 0x00 ; //to initialize the flags
	...
	/* transmit on rising edge and receive on falling edge */
	CLEAR_BIT(Reg_Value,0);
	...
	//then UBRR=(F_CPU/(16*BoudRate))-1=( (8*1000000)/(16*115200) )-1=3
