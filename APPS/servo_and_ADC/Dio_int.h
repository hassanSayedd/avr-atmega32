...
/*this function is used to make a certain pin as input or output , our pins is from 0 to 31*/
void Dio_vidSetPinVal(u8 Pin,u8 Val);
/*this function is used to set a certain pin to 0 or 1*/
u8 Dio_u8GetPinVal(u8 Pin);
// this function is used to know that the input pin if high or low

void Dio_vidTglPinVal(u8 Pin);
// this function is used to toggle the pin value
#endif /* DIO_INT_H_ */
